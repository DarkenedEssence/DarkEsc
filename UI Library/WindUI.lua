    ...
    function a.a()
        ...
        function j.NewRoundFrame(l, m, p, r, x, z)
            local function getImageForType(A)
                return A == "Squircle" and "rbxassetid://80999662900595" or A == "SquircleOutline" and "rbxassetid://117788349049947" or A == "SquircleOutline2" and "rbxassetid://117817408534198" or A == "Shadow-sm" and "rbxassetid://84825982946844" or A == "Squircle-TL-TR" and "rbxassetid://73569156276236" or A == "Squircle-BL-BR" and "rbxassetid://93853842912264" or A == "Square" and "rbxassetid://82909646051652"
            end
        ...
        function j.Drag(p, r, x)
            ...
            local function update(H)
                ...
                j.Tween(p, 0.02, {
                    Position = UDim2.new(
F.X.Scale, F.X.Offset + J.X, F.Y.Scale, F.Y.Offset + J.Y)
                }):Play()
            end
        ...
        function ad.Create(ae)
            ...
            function af.Open(ag)
                ...
                task.spawn(function()
                    ...
                    if not ae then
                        ac(af.UIElements.FullScreen, 0.1, {
                            BackgroundTransparency = .3
                        }):Play()
                    end
                    ac(af.UIElements.MainContainer, 0.1, {
                        ImageTransparency = 0
                    }):Play()
                    task.spawn(function()
                        task.wait(0.05)
...
g.Icon or h.Icon or Icons[g.Type] or "user", g.Icon or h.Icon or Icons[g.Type] or "user", 0, "Temp", "KeySystem", true)
    ...
    function a.r()
        ...
        function aa.new(ae)
            ...
            if af.Icon then
                ak = ab.Image(
af.Icon, af.Title .. ":" .. af.Icon, 0, ae.WindUI.Window, "Popup", true, ae.IconThemed)
        ...
        function aa.New(ae, af, ag)
            ...
            function ah.SetColor(al, am)
                ...
                if typeof(am) == "table" then
                    ...
                    local ao = ak:FindFirstChildOfClass"UIGradient" or ac("UIGradient", {
                        Parent = ak
                    })
                    ...
                    ad(ai, .06, {
                        TextColor3 = GetTextColorForHSB(am)
                    }):Play()
                    ad(ak, .06, {
                        ImageColor3 = am
                    }):Play()
    ...
    function a.w()
        ...
        function aa.New(af)
            ...
            function ag.SetIcon(an, ao)
                ...
                if ao then
                    ah = ab.Image(
ao, af.Title, 0, af.Folder, "OpenButton", true, af.IconThemed)
    ...
    function a.y()
        ...
        return function(ae)
            ...
            if af.Thumbnail then
                ak = aa.Image(
af.Thumbnail, af.Title, af.UICorner - 3, ae.Window.Folder, "Thumbnail", false, af.IconThemed)
                ak.Size = UDim2.new(1, 0, 0, ah)
            end
            if af.Image then
                al = aa.Image(
af.Image, af.Title, af.UICorner - 3, ae.Window.Folder, "Image", not af.Color and true or false)
...
af.Icon, af.Icon, 0, ae.Window.Folder, "Button", true, af.IconThemed)
            ...
            function ai.Set(as, at, au)
                if ap then
                    if not ai.IsFocusing and not af and (not au or (au.UserInputType == Enum.UserInputType.MouseButton1 or au.UserInputType == Enum.UserInputType.Touch)) then
                        ...
                        if at ~= an then
                            ad(ai.UIElements.SliderIcon.Frame, 0.08, {
    ...
    function a.H()
        ...
        function ak.New(al, am)
            local an = {
                ...
                Multi = am.Multi,
                Callback = am.Callback or function()
                end,
                UIElements = {},
                Opened = false,
                Tabs = {},
            ...
            function UpdatePosition()
                ...
                aq.Position = UDim2.new(0, ap.AbsolutePosition.X + ap.AbsoluteSize.X, 0, ap.AbsolutePosition.Y + ap.AbsoluteSize.Y - at + ak.MenuPadding)
            end
                    ...
                    af.AddSignal(av.UIElements.TabItem.MouseButton1Click, function()
                        if an.Multi then
                            if not av.Selected then
                                av.Selected = true
                                ah(av.UIElements.TabItem, 0.1, {
                                    ImageTransparency = .95
                                }):Play()
                                ah(av.UIElements.TabItem.Highlight, 0.1, {
                                    ImageTransparency = .75
                                }):Play()
                                ah(av.UIElements.TabItem.Frame.TextLabel, 0.1, {
                                    TextTransparency = 0
                                }):Play()
                            ...
                            for aw, ax in next, an.Tabs do
                                ah(ax.UIElements.TabItem, 0.1, {
                                    ImageTransparency = 1
                                }):Play()
                                ah(ax.UIElements.TabItem.Highlight, 0.1, {
                                    ImageTransparency = 1
                                }):Play()
                                ah(ax.UIElements.TabItem.Frame.TextLabel, 0.1, {
                                    TextTransparency = .5
                                }):Play()
                                ax.Selected = false
                            end
            ...
            af.AddSignal(aa.InputBegan, function(ap)
                if ap.UserInputType == Enum.UserInputType.MouseButton1 or ap.UserInputType == Enum.UserInputType.Touch then
                    ...
                    if am.Window.CanDropdown and an.Opened and (ac.X < aq.X or ac.X > aq.X + as.X or ac.Y < (aq.Y - 20 - 1) or ac.Y > aq.Y + as.Y) then
                        an:Close()
                    end
                end
            end)
    ...
    function a.L()
        ...
        function an.Colorpicker(ao, ap, aq, as)
            ...
            local p = {
                ...
                },
                {
                    ...
                    Variant = "Primary",
                    Callback = function()
                        as(Color3.fromHSV(at.Hue, at.Sat, at.Vib), at.Transparency)
                    end
                }
            }
            ...
            function at.Update(C, F, G)
                if F then
                    aw, ax, ay = Color3.toHSV(F)
                else
                    aw, ax, ay = at.Hue, at.Sat, at.Vib
                end
        ...
        function an.New(ao, ap)
            local aq = {
                ...
                Callback = ap.Callback or function()
                end,
                Transparency = ap.Transparency,
                UIElements = {}
            }
            local as = true
            if ap.Window.NewElements then
                an.UICorner = 14
            end
    ...
    function a.M()
        ...
        function af.New(ag, ah)
            ...
            function ai.SetIcon(ak, al)
                ...
                if al then
                    aj = aa.Image(
al, al .. ":" .. ai.Title, 0, ah.Window.Folder, ai.__type, true)
            ...
            local al = ac("TextLabel", {
                ...
                FontFace = Font.new(aa.Font, Enum.FontWeight.SemiBold),
                Text = ai.Title,
                Size = UDim2.new(1, aj and (- ai.IconSize - 8) * 2 or (- ai.IconSize - 8), 0, 0),
                TextWrapped = true,
            })
            local am = ac("Frame", {
                Size = UDim2.new(1, 0, 0, 0),
    ...
    function a.Q()
        ...
        function ai.New(aj, ak)
            ...
            if al.Icon then
                ao = ac.Image(
al.Icon, al.Icon .. ":" .. al.Title, 0, Window.Folder, al.__type, true, al.IconThemed)
...
al.Icon, al.Icon .. ":" .. al.Title, 0, Window.Folder, al.__type, true, al.IconThemed)
            ...
            ac.AddSignal(al.UIElements.Main.MouseEnter, function()
                if not al.Locked then
                    af(al.UIElements.Main.Frame, 0.08, {
            ...
            if not ai.Tabs[ak].Locked then
                ...
                for al, am in next, ai.Tabs do
                    if not am.Locked then
                        af(am.UIElements.Main, 0.15, {
                            ImageTransparency = 1
                        }):Play()
                        af(am.UIElements.Main.Outline, 0.15, {
                            ImageTransparency = 1
                        }):Play()
                        af(am.UIElements.Main.Frame.TextLabel, 0.15, {
                            TextTransparency = 0.3
                        }):Play()
                        if am.UIElements.Icon then
                            af(am.UIElements.Icon.ImageLabel, 0.15, {
                ...
                af(ai.Tabs[ak].UIElements.Main, 0.15, {
                    ImageTransparency = 0.95
                }):Play()
                af(ai.Tabs[ak].UIElements.Main.Outline, 0.15, {
                    ImageTransparency = 0.85
                }):Play()
                af(ai.Tabs[ak].UIElements.Main.Frame.TextLabel, 0.15, {
                    TextTransparency = 0
                }):Play()
                if ai.Tabs[ak].UIElements.Icon then
                    af(ai.Tabs[ak].UIElements.Icon.ImageLabel, 0.15, {
    ...
    function a.R()
        ...
        function aa.New(ah, ai, aj, ak, al)
            ...
            if am.Icon then
                an = ac.Image(
am.Icon, am.Icon, 0, aj, "Section", true, am.IconThemed)
            ...
            local ap = ae("Frame", {
                ...
                ae("TextButton", {
                    ...
                    ae("TextLabel", {
                        Text = am.Title,
                        TextXAlignment = "Left",
                        Size = UDim2.new(1, an and (- am.IconSize - 10) * 2 or (- am.IconSize - 10), 1, 0),
                        ThemeTag = {
                            TextColor3 = "Text",
                        },
                        FontFace = Font.new(ac.Font, Enum.FontWeight.SemiBold),
    ...
    function a.T()
        ...
        function aa.new(ag, ah, ai)
            ...
            local ak = ae("TextBox", {
                ...
                Size = UDim2.new(1, - ((aj.IconSize * 2) + (aj.Padding * 2)), 0, 0),
                AutomaticSize = "Y",
                ClipsDescendants = true,
                ClearTextOnFocus = false,
                BackgroundTransparency = 1,
...
gradient.Parent = icon
                ...
                aw.Main.Size = UDim2.new(1, 0, 0, aw.Main.Outline.Frame.Desc.Visible and (((aj.Padding - 2) * 2) + aw.Main.Outline.Frame.Title.TextBounds.Y + 6 + aw.Main.Outline.Frame.Desc.TextBounds.Y) or (((aj.Padding - 2) * 2) + aw.Main.Outline.Frame.Title.TextBounds.Y))
                ac.AddSignal(aw.Main.MouseEnter, function()
                    af(aw.Main, .04, {
                        ImageTransparency = .95
                    }):Play()
                    af(aw.Main.Outline, .04, {
                        ImageTransparency = .7
                    }):Play()
                end)
            ...
            ac.AddSignal(am.UIListLayout:GetPropertyChangedSignal"AbsoluteContentSize", function()
                af(am, .06, {
                    Size = UDim2.new(1, 0, 0, math.clamp(am.UIListLayout.AbsoluteContentSize.Y + (aj.Padding * 2), 0, aj.MaxHeight))
    ...
    function a.U()
        ...
        return function(an)
            ...
            ao.Size = UDim2.new(
ap.X.Scale, math.clamp(ap.X.Offset, ao.MinSize.X, ao.MaxSize.X), ap.Y.Scale, math.clamp(ap.Y.Offset, ao.MinSize.Y, ao.MaxSize.Y))
            ...
            local as, at = ae.AcrylicPaint{
                UseAcrylic = ao.Acrylic
            }
            ao.AcrylicPaint = as
            local au = ag("Frame", {
            ...
            ao.UIElements.SideBar = ag("ScrollingFrame", {
                Size = UDim2.new(1, ao.ScrollBarEnabled and - 3 - (ao.UIPadding / 2) or 0, 1, not ao.HideSearchBar and - 45 or 0),
                Position = UDim2.new(0, 0, 1, 0),
                AnchorPoint = Vector2.new(0, 1),
                BackgroundTransparency = 1,
                ScrollBarThickness = 0,
            ...
            ao.UIElements.SideBarContainer = ag("Frame", {
                ...
                ag("Frame", {
                    Name = "Content",
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, 0, 1, not ao.HideSearchBar and - 45 - ao.UIPadding / 2 or 0),
                    Position = UDim2.new(0, 0, 1, 0),
                    AnchorPoint = Vector2.new(0, 1),
                }),
            ...
            if ao.User then
                local function getUserThumb()
                    local aA, aB = game.Players:GetUserThumbnailAsync(
ao.User.Anonymous and 1 or game.Players.LocalPlayer.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420)
                    return aA
                end
                az = ag("TextButton", {
                    Size = UDim2.new(0, (ao.UIElements.SideBarContainer.AbsoluteSize.X) - (ao.UIPadding / 2), 0, 42 + (ao.UIPadding)),
                ...
                function ao.User.Enable(aA)
                    ...
                    ah(ao.UIElements.SideBarContainer, .25, {
                        Size = UDim2.new(0, ao.SideBarWidth, 1, - 94 - (ao.UIPadding * 2))
                    }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                    az.Visible = true
                end
                function ao.User.Disable(aA)
                    ...
                    ah(ao.UIElements.SideBarContainer, .25, {
                        Size = UDim2.new(0, ao.SideBarWidth, 1, - 52)
                    }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                    az.Visible = false
                end
            ...
            af.AddSignal(ao.UIElements.Main.Main.Topbar.Left:GetPropertyChangedSignal"AbsoluteSize", function()
                ...
                ao.UIElements.Main.Main.Topbar.Center.Size = UDim2.new(1, - i - j - (ao.UIPadding * 2), 1, 0)
            end)
            function ao.CreateTopbarButton(i, j, l, m, p, r)
                local x = af.Image(
l, l, 0, ao.Folder, "TopbarIcon", true, r)
            ...
            local i = af.Drag(
ao.UIElements.Main, {
                ao.UIElements.Main.Main.Topbar,
                b.Frame
            }, function(i, j)
            ...
            task.spawn(function()
                if ao.Icon then
                    g = af.Image(
ao.Icon, ao.Title, 0, ao.Folder, "Window", true, ao.IconThemed)
            ...
            function ao.SetUIScale(p, r)
                an.WindUI.UIScale = r
                ah(an.WindUI.ScreenGui.UIScale, .2, {
                    Scale = r
                }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
            end
            do
                if (ac.ViewportSize.X - 40 < ao.UIElements.Main.AbsoluteSize.X) or (ac.ViewportSize.Y - 40 < ao.UIElements.Main.AbsoluteSize.Y) then
            ...
            function ao.Dialog(A, B)
                ...
                if B.Icon then
                    H = af.Image(
B.Icon, C.Title .. ":" .. B.Icon, 0, ao, "Dialog", true, B.IconThemed)
            ...
            function ao.Tag(A, B)
                if ao.UIElements.Main.Main.Topbar.Center.Visible == false then
                    ao.UIElements.Main.Main.Topbar.Center.Visible = true
                end
            ...
            af.AddSignal(aa.InputChanged, function(A)
                if A.UserInputType == Enum.UserInputType.MouseMovement or A.UserInputType == Enum.UserInputType.Touch then
                    if isResizing and ao.CanResize then
                        ...
                        C = UDim2.new(
C.X.Scale, math.clamp(C.X.Offset, ao.MinSize.X, ao.MaxSize.X), C.Y.Scale, math.clamp(C.Y.Offset, ao.MinSize.Y, ao.MaxSize.Y))
...
function aa.Gradient(aq, as, at)
    ...
    table.sort(au, function(ay, az)
        return ay.Time < az.Time
    end)
    table.sort(av, function(ay, az)
        return ay.Time < az.Time
    end)
    if # au < 2 then
    ...
    if as.KeySystem then
        ...
        if not as.KeySystem.API then
            if as.KeySystem.SaveKey and isfile(ay) then
                ...
                local aA = (type(as.KeySystem.Key) == "table") and table.find(as.KeySystem.Key, az) or tostring(as.KeySystem.Key) == tostring(az)
                if aA then
                    au = true
                else
                    loadKeysystem()
